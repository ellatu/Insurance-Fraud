...
def plt_hist(data, bins, xlim=(0, 50),
             hist_color='#006699', kde_color='blue',
             title='D1 AE Reconstruction Errors', show_threshold=True):
    # 计算KDE曲线
    # 保证数据非负
...
def plt_hist2(data1, data2,bins1, bins2,xlim=(0,50),
             hist_color='#006699',
             title='D1 AE Reconstruction Errors', show_threshold=True):
    # 计算KDE曲线1
    # 保证数据非负
...
if __name__ == "__main__":
    ...
    print(top30_labels_desc)
    print(top30_values_desc)

    # AE 变量重要性
    plt.figure(figsize=(10, 6))
    plt.bar(top30_labels_desc, top30_values_desc)
