...
def training(X_train,model,epochs,title):
    ...
    if isinstance(Model, Autoencoder):  # 检查模型类型
        Model.save("ae_model_d1_3.keras")
    return
...
if __name__ == "__main__":
    # 清理数据
    X_scaled, y, X_train, X_test, y_train, y_test = clean_fuction('d1_清理_原始.csv', 'fraud_reported')
