...
# 假设你的数据集是一个CSV文件
data = pd.read_csv("/Users/ellatu/Desktop/毕业论文/文献数据/数据/creditcard.csv")
...
# 初始化孤立森林模型
iso_forest = IsolationForest(n_estimators=100, contamination=0.001727, random_state=42)  # contamination参数表示异常点的比例
...
# 查看异常点中欺诈样本的比例
fraud_in_anomalies = data_cleaned[data_cleaned['anomaly'] == 1]['Class'].mean()
