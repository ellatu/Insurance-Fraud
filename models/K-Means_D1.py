...
# 假设你的数据集是一个CSV文件
data = pd.read_csv("/Users/ellatu/Desktop/毕业论文/文献数据/数据/d1_清理.csv")
...
plt.title('D1 Clustering (2D PCA)')
...
# 查看每个簇中欺诈样本的比例
fraud_by_cluster = data_cleaned.groupby('cluster')['fraud_reported'].mean()
